...
import ViewerWorkspaceDiscovery from '@/components/ViewerWorkspaceDiscovery';
            ...
            <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div className="lg:col-span-2">
                        <DatasetTable datasets={datasets} onRefresh={() => fetchDashboardData()} />
                    </div>
