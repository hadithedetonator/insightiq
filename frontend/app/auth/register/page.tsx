        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans text-slate-50">
            ...
            <div className="w-full max-w-md bg-slate-900 border border-slate-800 p-8 rounded-3xl shadow-2xl relative z-10">
                <div className="flex flex-col items-center mb-8 text-center">
                    ...
                    <p className="text-slate-400 mt-2">Start transforming your data into insights.</p>
                </div>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-slate-950 border border-slate-800 rounded-xl py-3 px-4 focus:ring-2 focus:ring-indigo-600 outline-none transition-all text-sm"
                        />
                    </div>
                    <div>
                    ...
                    <div className="pt-2">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-indigo-900/20 active:scale-[0.98]"
                        >
                ...
                <p className="text-center text-slate-500 text-sm mt-8">
                    Already have an account? <Link href="/auth/login" className="text-indigo-400 font-bold hover:underline">Log in</Link>
                </p>
            </div>
        </div>
    );
